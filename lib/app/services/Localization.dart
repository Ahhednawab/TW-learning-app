...
class LocalizationController extends GetxController {
  ...
  void loadCurrentLanguage({bool isUpdate = true}) async {
    ...
    for(int index = 0; index<AppConstants.languages.length; index++) {
      if((AppConstants.languages[index].languageCode == _locale.languageCode) && (AppConstants.languages[index].languageCode == (Get.locale?.languageCode ?? true))) {
        _selectedIndex = index;
        break;
      }else if((AppConstants.languages[index].languageCode != _locale.languageCode) && (AppConstants.languages[index].languageCode == (Get.locale?.languageCode ?? true))){
        _selectedIndex = index;
        break;
      }
    }
